...
std::vector<TranslationTask> GetTranslationPool(Difficulty difficulty) {
    ...
    std::vector<TranslationTask> hard = {
      ...
      {"She has been studying French for three years", "Она изучает французский уже три года",
       "Duration with уже + present tense"},
      {"If I had known, I would have come earlier", "Если бы я знал, я бы пришёл раньше",
      ...
      {"We need to finish this project by Friday", "Нам нужно закончить этот проект к пятнице",
       "Need = нужно, by = к + dative"},
      {"He said that he would call tomorrow", "Он сказал, что позвонит завтра",
      ...
      {"The train arrives at half past seven", "Поезд прибывает в половине восьмого",
      ...
      {"It seems to me that it is going to snow", "Мне кажется, что будет снег",
...
std::vector<GrammarTask> GetGrammarPool(Difficulty difficulty) {
    std::vector<GrammarTask> easy = {
      ...
      {"Она ___ книгу.",
       {"читает", "читать", "читал", "читаю"},
       0,
       "3rd person singular, present tense of читать."},
      {"Мы ___ в школу.", {"идём", "идёт", "идти", "идут"}, 0, "1st person plural of идти."},
      {"Он ___ воду.", {"пьёт", "пить", "пьём", "пью"}, 0, "3rd person singular of пить."},
      {"Ты ___ музыку?",
       {"слушаешь", "слушает", "слушаю", "слушать"},
       0,
       "2nd person singular of слушать."},
      {"Кот ___ на диване.",
       {"сидит", "сидеть", "сидят", "сижу"},
       0,
       "3rd person singular of сидеть."},
      {"Я ___ кофе.", {"люблю", "любит", "любить", "любим"}, 0, "1st person singular of любить."},
      {"Они ___ в парке.",
       {"гуляют", "гулять", "гуляет", "гуляю"},
       0,
    ...
    std::vector<GrammarTask> medium = {
      {"Вчера я ___ в кино.",
       {"ходил", "хожу", "пойду", "иду"},
       0,
       "Past tense, masculine of ходить."},
      {"Она ___ письмо вчера.",
       {"написала", "напишет", "пишет", "писать"},
       0,
       "Past tense, perfective, feminine of написать."},
      {"Мы ___ эту книгу завтра.",
       {"прочитаем", "читаем", "читали", "читать"},
       0,
       "Future tense, perfective of прочитать."},
      {"Если бы я ___, я бы помог.",
       {"знал", "знаю", "узнаю", "знать"},
       0,
       "Subjunctive mood uses past tense."},
      {"Дети ___ в саду каждый день.",
       {"играют", "играли", "будут играть", "играть"},
       0,
       "Present tense for habitual actions."},
      {"Она ___ по-английски очень хорошо.",
       {"говорит", "говорить", "сказала", "скажет"},
       0,
       "Present tense, 3rd person of говорить."},
      {"Я ___ тебе завтра.",
       {"позвоню", "звоню", "звонил", "звонить"},
       0,
       "Future tense, perfective of позвонить."},
      {"Студенты ___ экзамен на прошлой неделе.",
       {"сдали", "сдают", "сдадут", "сдавать"},
       0,
       "Past tense, perfective of сдать."},
      {"Мы ___ здесь уже два часа.",
       {"сидим", "сидели", "посидим", "сидеть"},
       0,
    ...
    std::vector<GrammarTask> hard = {
      {"Книга, ___ ты мне дал, была интересной.",
       {"которую", "которая", "которой", "которым"},
       0,
